...
# docker build -t white_tree_furniture .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name white_tree_furniture white_tree_furniture
